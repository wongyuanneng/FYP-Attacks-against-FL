...
class Generator(nn.Module):
    ...
    '''
    def __init__(self, use_gpu, nc, nz, ngf, alpha=.2):
        '''
...
class Discriminator(SimpleNet):
    ...
    '''
    def __init__(self, use_gpu, nc, ndf, alpha=.2, drop_rate=.5, num_classes=10):
        '''
        ...
        '''
        super(Discriminator, self).__init__(in_channels=128, kernel_size=2)
        self.use_gpu = use_gpu
        ...
        self._features = nn.AvgPool2d(kernel_size=2)
